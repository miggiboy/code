...
use App\City;
use App\Models\University\{University, ReceptionCommittee};

use App\Http\Requests\University\{UpdateUniversityRequest, StoreUniversityRequest};
...
class UniversitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        $universities = University::orderBy('title')->with(['city', 'media', 'marks'])->paginate(15);
    ...
    {
        $university = University::create($request->except('reception', 'add_specialities'));
